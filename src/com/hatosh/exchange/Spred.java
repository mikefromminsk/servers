...
public class Spred extends ExchangeUtils implements InfiniteTimer.Callback {

    InfiniteTimer minTimers;
    InfiniteTimer dayTimers;
    InfiniteTimer weekTimers;
    String domain;
    public Spred(String domain) {
        this.domain = domain;
        minTimers = new InfiniteTimer(this,  1000, 1000 * 60);
        dayTimers = new InfiniteTimer(this,  1000 * 60, 1000 * 60 * 60 * 24);
        weekTimers = new InfiniteTimer(this,  1000 * 60 * 60 * 24, 1000 * 60 * 60 * 24 * 7);
    }
    ...
    public void spred(){
        String botAddress = "bot_spred_" + domain;
